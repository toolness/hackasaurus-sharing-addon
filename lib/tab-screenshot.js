...
function getThumbnailCanvasForWindow(window) {
  ...
  console.log("img is " + thumbnail.width + "x" + thumbnail.height);
  let ctx = thumbnail.getContext("2d");
  ctx.drawWindow(window, 0, 0, thumbnail.width, thumbnail.height, COLOR);
  return thumbnail;
}
...
exports.getCanvas = function() {
  ...
  return getThumbnailCanvasForWindow(window);
};
